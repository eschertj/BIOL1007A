...
7. Select the desired save location for this project under *Create project as subdirectory of:*
+ I recommend saving the projects to your Desktop for ease 
8. You've now created a repository which will allow you to work with all your files in one place 
...
1. In the 2nd quadrant if your screen, navigate to the terminal tab and enter these commands with the exact case and syntax below:
  ...
  + git push 
2. your website will have the following format: YourGitHubUsername.github.io/RepositoryName/
3. You're done, enjoy your website! 
